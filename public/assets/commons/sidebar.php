    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            ...
            <li class="submenu-open">
                ...
                <ul>
                    <li><a href="../pdv"><i data-feather="shopping-bag"></i><span>PDV</span></a></li>
                    <li><a href="#"><i data-feather="clock"></i><span>Historial</span></a></li>
                    <li><a href="#"><i data-feather="package"></i><span>Pedidos</span></a></li>
                </ul>
            </li>
            <li class="submenu-open">
                <h6 class="submenu-hdr">Inventario</h6>
                <ul>
                    <li><a href="../productoListado"><i data-feather="box"></i><span>Productos</span></a></li>
                    <li><a href="../productoAgregar/"><i data-feather="plus-square"></i><span>Añadir producto</span></a></li>
                    <li><a href="#"><i data-feather="trending-down"></i><span>Bajo stock</span></a></li>
                    <li><a href="#"><i data-feather="codepen"></i><span>Categoría</span></a></li>
                </ul>
            </li>
            <li class="submenu-open">
                <h6 class="submenu-hdr">Personas</h6>
                <ul>
                    <li><a href="#"><i data-feather="user"></i><span>Empleados</span></a></li>
                    <li><a href="../cliente"><i data-feather="user"></i><span>Clientes</span></a></li>
                </ul>
            </li>
